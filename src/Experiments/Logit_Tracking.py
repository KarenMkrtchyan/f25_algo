...
models = ["gpt2-small"]
prompts = ["Is 7 > 3? Answer:", "Is 56 > 78? Answer:", "Is 512 > 678? Answer:", "Is 6789 > 5678? Answer:"]
...
for model_name in models:
    ...
    for text in prompts:
        ...
        plot_path = os.path.join(output_folder, f"{text}--{candidates}.png")
        csv_path = os.path.join(output_folder, f"{text}--{candidates}.csv")
